...
@section('content')
    <div class="card">
    <div class="card-body">
            <form method="POST" action="/servis/{{$ser->id}}">
                @method('PUT')
                @csrf                
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="no_polisi" value="{{$ser->no_polisi}}" class="form-control" id="exampleInputPassword1">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="perbaikan" value="{{$ser->perbaikan}}" class="form-control" id="exampleInputPassword1">
                </div>
