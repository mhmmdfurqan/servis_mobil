                            ...
                            <ul class="nk-menu">                               
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        ...
                                        <span class="nk-menu-text">Customer</span><span class="nk-menu-badge">New</span>
                                    </a>
                                    <ul class="nk-menu-sub">
                                        ...
                                        <li class="nk-menu-item">
                                            <a href="customer/form" class="nk-menu-link"><span class="nk-menu-text">Customer Add</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item has-sub">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        ...
                                        <span class="nk-menu-text">Jabatan</span>
                                    </a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="jabatan" class="nk-menu-link"><span class="nk-menu-text">Jabatan List</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="jabatan/form" class="nk-menu-link"><span class="nk-menu-text">Jabatan Add</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item has-sub">
                                    <a href="#" class="nk-menu-link nk-menu-toggle">
                                        <span class="nk-menu-icon"><em class="bi bi-gear-fill"></em></span>
